...
+ (void) configureWithNavigationController:(UINavigationController *)controller 
    ...
    manager.sideMenuController.view.frame = CGRectMake(0, 20, kSidebarWidth, 552);

    [controller setMenuState:MFSideMenuStateHidden];
    //Resitricts frame so it doesn't go to the bottom of the screen
    manager.sideMenuController.view.frame = CGRectMake(0, 20, kSidebarWidth, 552);

    manager.sideMenuController.tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
...
//    [tapRecognizer release];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:manager 
                                             selector:@selector(flipViewAccordingToStatusBarOrientation:) 
                                               ...
                                               object:nil];
    //Settings for the shadow from the main view on to the side menu
    controller.view.layer.shadowOpacity = .95f;
    controller.view.layer.shadowRadius = 15.0f;
    //controller.view.layer.shadowColor = [UIColor colorWithRed:0.349 green:0.035 blue:0 alpha:1]; //[UIColor colorWithRed:0.349 green:0.035 blue:0 alpha:1] /*#590900*/.CGColor;
